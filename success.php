...
<div class="as-search-wrapper" role="main">
    ...
    <h1 style="text-align: center;">Pagamento realizado com sucesso!</h1>
    <div style="margin: 10px;">
        <p>
            <b>collection_id: </b> <?php echo $_GET["collection_id"]; ?>
        </p>
        <p>
            <b>payment_type: </b> <?php echo $_GET["payment_type"]; ?>
        </p>
        <p>
            <b>external_reference: </b> <?php echo $_GET["external_reference"]; ?>
        </p>
        <p>
            <b>preference_id:</b> <?php echo $_GET["preference_id"]; ?>
        </p>
        <p>
            <b>site_id:</b> <?php echo $_GET["site_id"] ?>
        </p>
    </div>
